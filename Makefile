...
.PHONY: all alpine centos debian fedora opensuse ubuntu

all: alpine centos debian fedora opensuse ubuntu
...
debian:
	...
	base=debian ver=bullseye  shdocker -s _debian_ubuntu -d debian/bullseye/Dockerfile                 2>/dev/null
	base=debian ver=buster    shdocker -s _debian_ubuntu -d debian/buster/Dockerfile                   2>/dev/null
	base=debian ver=sid       shdocker -s _debian_ubuntu -d debian/sid/Dockerfile                      2>/dev/null
...
ubuntu:
	...
	base=ubuntu ver=bionic shdocker -s _debian_ubuntu -d ubuntu/bionic/Dockerfile                      2>/dev/null
	base=ubuntu ver=focal  shdocker -s _debian_ubuntu -d ubuntu/focal/Dockerfile                       2>/dev/null
